...
import { FaBed, FaBath, FaRulerCombined, FaTimes, Facheck, FaMapMarker, FaCheck } from 'react-icons/fa'
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                >
                    ...
                    <p>
                        ...
                        {property.sqaure_feet} {' '} <span className="hidden sm:inline">sqft</span>
                    </p>
                </div>
